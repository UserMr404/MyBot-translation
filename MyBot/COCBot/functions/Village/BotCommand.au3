				...
				Case 1
					If $g_bChkForceAttackOnClanGamesWhenHalt And Not $g_bClanGamesCompleted Then
						...
						If $IsCGEventRunning Then
							SetLog("Clan Games challenge in progress, finish it first")
							Return False
						EndIf
					EndIf
				...
				Case 7
					...
					If ProfileSwitchAccountEnabled() Then
						...
						If UBound($aActiveAccount) >= 2 Then
							...
							checkSwitchAcc()
						Else
							SetLog("This is the last account to turn off, stop bot now", $COLOR_INFO)
							If _Sleep($DELAYBOTCOMMAND1) Then Return
							CloseCoC()
							Return True
						EndIf
