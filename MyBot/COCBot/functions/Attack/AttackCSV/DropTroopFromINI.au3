...
Func DropTroopFromINI($sDropVectors, $iStartIndex, $iEndIndex, $aiIndexArray, $iMinQuantity, $iMaxQuantity, $sTroopName, $delayPointmin, $delayPointmax, $delayDropMin, $delayDropMax, $sleepafterMin, $sleepAfterMax, $bDebug = False)
	...
	Switch $iTroopIndex
		Case $eLSpell
			If $g_aiAttackAlgorithm[$g_iMatchMode] <> 1 And Not $g_abAttackUseLightSpell[$g_iMatchMode] Then $bUseSpell = False
		Case $eHSpell
			If $g_aiAttackAlgorithm[$g_iMatchMode] <> 1 And Not $g_abAttackUseHealSpell[$g_iMatchMode] Then $bUseSpell = False
		Case $eRSpell
			If $g_aiAttackAlgorithm[$g_iMatchMode] <> 1 And Not $g_abAttackUseRageSpell[$g_iMatchMode] Then $bUseSpell = False
		Case $eJSpell
			If $g_aiAttackAlgorithm[$g_iMatchMode] <> 1 And Not $g_abAttackUseJumpSpell[$g_iMatchMode] Then $bUseSpell = False
		Case $eFSpell
			If $g_aiAttackAlgorithm[$g_iMatchMode] <> 1 And Not $g_abAttackUseFreezeSpell[$g_iMatchMode] Then $bUseSpell = False
		Case $eCSpell
			If $g_aiAttackAlgorithm[$g_iMatchMode] <> 1 And Not $g_abAttackUseCloneSpell[$g_iMatchMode] Then $bUseSpell = False
		Case $eISpell
			If $g_aiAttackAlgorithm[$g_iMatchMode] <> 1 And Not $g_abAttackUseInvisibilitySpell[$g_iMatchMode] Then $bUseSpell = False
		Case $eReSpell
			If $g_aiAttackAlgorithm[$g_iMatchMode] <> 1 And Not $g_abAttackUseRecallSpell[$g_iMatchMode] Then $bUseSpell = False
		Case $eRvSpell
			If $g_aiAttackAlgorithm[$g_iMatchMode] <> 1 And Not $g_abAttackUseReviveSpell[$g_iMatchMode] Then $bUseSpell = False
		Case $eTSpell
			If $g_aiAttackAlgorithm[$g_iMatchMode] <> 1 And Not $g_abAttackUseTotemSpell[$g_iMatchMode] Then $bUseSpell = False
		Case $ePSpell
			If $g_aiAttackAlgorithm[$g_iMatchMode] <> 1 And Not $g_abAttackUsePoisonSpell[$g_iMatchMode] Then $bUseSpell = False
		Case $eESpell
			If $g_aiAttackAlgorithm[$g_iMatchMode] <> 1 And Not $g_abAttackUseEarthquakeSpell[$g_iMatchMode] Then $bUseSpell = False
		Case $eHaSpell
			If $g_aiAttackAlgorithm[$g_iMatchMode] <> 1 And Not $g_abAttackUseHasteSpell[$g_iMatchMode] Then $bUseSpell = False
		Case $eSkSpell
			If $g_aiAttackAlgorithm[$g_iMatchMode] <> 1 And Not $g_abAttackUseSkeletonSpell[$g_iMatchMode] Then $bUseSpell = False
		Case $eBtSpell
			If $g_aiAttackAlgorithm[$g_iMatchMode] <> 1 And Not $g_abAttackUseBatSpell[$g_iMatchMode] Then $bUseSpell = False
		Case $eOgSpell
			If $g_aiAttackAlgorithm[$g_iMatchMode] <> 1 And Not $g_abAttackUseOvergrowthSpell[$g_iMatchMode] Then $bUseSpell = False
		Case $eIBSpell
			If $g_aiAttackAlgorithm[$g_iMatchMode] <> 1 And Not $g_abAttackUseIBSpell[$g_iMatchMode] Then $bUseSpell = False
