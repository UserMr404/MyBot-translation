...
Func DragAttackBar($iTotalSlot = 20, $bBack = False)
	...
	If Not $bBack Then
		...
		ClickDrag(25 + 73 * ($iTotalSlot - 9), 625 + $g_iBottomOffsetY, 25, 625 + $g_iBottomOffsetY, 1000)
	...
	Else
		...
		ClickDrag(25, 625 + $g_iBottomOffsetY, 25 + 73 * ($iTotalSlot - 9), 625 + $g_iBottomOffsetY, 1000)
