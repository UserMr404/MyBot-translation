...
Func getArmyHeroTime($iHeroType, $bOpenArmyWindow = False, $bCloseArmyWindow = False)
	...
	If $iHeroType <> $eHeroKing And $iHeroType <> $eHeroQueen And $iHeroType <> $eHeroPrince And $iHeroType <> $eHeroWarden And $iHeroType <> $eHeroChampion And $iHeroType <> $eHeroDragonDuke And StringInStr($iHeroType, "all", $STR_NOCASESENSEBASIC) = 0 Then
	...
	If $iHeroType = $eHeroKing Or $iHeroType = $eHeroQueen Or $iHeroType = $eHeroPrince Or $iHeroType = $eHeroWarden Or $iHeroType = $eHeroChampion Or $iHeroType = $eHeroDragonDuke Then
