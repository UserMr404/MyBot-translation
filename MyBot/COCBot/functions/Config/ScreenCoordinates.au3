...
Global $aEndFightSceneAvl[4] = [260, 195 + $g_iMidOffsetY, 0xFEEA87, 20] ; Victory or defeat scene left side ribbon = light gold
...
; Dragon Duke Health Bar, check at the middle of the bar, index - 10 is x-offset added to middle of health bar
