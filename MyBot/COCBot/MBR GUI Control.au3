...
Func InitializeMainGUI($bGuiModeUpdate = False)
	...
	If $g_bDevMode Then
		...
		GUICtrlSetState($g_hBtnDirectAttack, $GUI_SHOW + $GUI_ENABLE)
...
Func SetTime($bForceUpdate = False)
	...
	If (GUICtrlRead($g_hGUI_STATS_TAB, 1) = $g_hGUI_STATS_TAB_ITEM2 And GUICtrlRead($g_hTabMain, 1) = $g_hTabStats) Or $bForceUpdate = True Then
	...
	If ProfileSwitchAccountEnabled() Then
		If GUICtrlRead($g_hGUI_STATS_TAB, 1) = $g_hGUI_STATS_TAB_ITEM5 And GUICtrlRead($g_hTabMain, 1) = $g_hTabStats Then
...
Func Bind_ImageList($nCtrl, ByRef $hImageList)
	...
	Switch $nCtrl
		Case $g_hTabMain
			...
			Local $aIconIndex = [$eIcnHourGlass, $eIcnTH17, $eIcnAttack, $eIcnGUI, $eIcnGoldElixir, $eIcnInfo]
