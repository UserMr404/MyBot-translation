...
Func cmbDirectAttackMode()
	Local $sSelected = GUICtrlRead($g_hCmbDirectAttackMode)
	If $sSelected = "Dead Base" Then
		$g_iDirectAttackMode = $DB
	Else
		$g_iDirectAttackMode = $LB
	EndIf
EndFunc   ;==>cmbDirectAttackMode

Func txtCCSpamInterval()
	Local $iVal = Int(GUICtrlRead($g_hTxtCCSpamInterval))
	If $iVal < 5 Then $iVal = 5
	If $iVal > 300 Then $iVal = 300
	$g_iCCSpamInterval = $iVal
EndFunc   ;==>txtCCSpamInterval
...
Func HideAllTroops()
	...
	For $i = $g_ahTxtTrainArmyTroopCount[$eTroopMinion] To $g_ahTxtTrainArmyTroopCount[$eTroopFurnace]
		GUICtrlSetState($i, $GUI_HIDE)
	Next
	For $i = $g_ahPicTrainArmyTroop[$eTroopBarbarian] To $g_ahPicTrainArmyTroop[$eTroopMeteorGolem]
		GUICtrlSetState($i, $GUI_HIDE)
	Next
	For $i = $g_ahTxtTrainArmyTroopCount[$eTroopBarbarian] To $g_ahTxtTrainArmyTroopCount[$eTroopMeteorGolem]
		GUICtrlSetState($i, $GUI_HIDE)
	Next
	For $i = $g_ahPicTrainArmyTroop[$eTroopSuperBarbarian] To $g_ahPicTrainArmyTroop[$eTroopSuperYeti]
		GUICtrlSetState($i, $GUI_HIDE)
	Next
	For $i = $g_ahTxtTrainArmyTroopCount[$eTroopSuperBarbarian] To $g_ahTxtTrainArmyTroopCount[$eTroopSuperYeti]
		GUICtrlSetState($i, $GUI_HIDE)
	Next
	For $i = $g_ahPicTrainArmyTroop[$eTroopIceMinion] To $g_ahPicTrainArmyTroop[$eTroopRamRider]
		GUICtrlSetState($i, $GUI_HIDE)
	Next
	For $i = $g_ahTxtTrainArmyTroopCount[$eTroopIceMinion] To $g_ahTxtTrainArmyTroopCount[$eTroopRamRider]
		GUICtrlSetState($i, $GUI_HIDE)
	Next
	For $i = $g_ahPicTrainArmySpell[$eSpellLightning] To $g_ahPicTrainArmySpell[$eSpellIBSpell]
		GUICtrlSetState($i, $GUI_HIDE)
	Next
	For $i = $g_ahTxtTrainArmySpellCount[$eSpellLightning] To $g_ahTxtTrainArmySpellCount[$eSpellIBSpell]
		GUICtrlSetState($i, $GUI_HIDE)
	Next
...
Func BtnEventTroops()
	HideAllTroops()
	; Event Troops: Ice Minion, Ice Wizard, Giant Giant, Azure Dragon, Firecracker, Ram Rider
	GUICtrlSetState($g_ahPicTrainArmyTroop[$eTroopIceMinion], $GUI_SHOW)
	GUICtrlSetState($g_ahTxtTrainArmyTroopCount[$eTroopIceMinion], $GUI_SHOW)
	GUICtrlSetState($g_ahPicTrainArmyTroop[$eTroopIceWizard], $GUI_SHOW)
	GUICtrlSetState($g_ahTxtTrainArmyTroopCount[$eTroopIceWizard], $GUI_SHOW)
	GUICtrlSetState($g_ahPicTrainArmyTroop[$eTroopGGiant], $GUI_SHOW)
	GUICtrlSetState($g_ahTxtTrainArmyTroopCount[$eTroopGGiant], $GUI_SHOW)
	GUICtrlSetState($g_ahPicTrainArmyTroop[$eTroopAzureDragon], $GUI_SHOW)
	GUICtrlSetState($g_ahTxtTrainArmyTroopCount[$eTroopAzureDragon], $GUI_SHOW)
	GUICtrlSetState($g_ahPicTrainArmyTroop[$eTroopFirecracker], $GUI_SHOW)
	GUICtrlSetState($g_ahTxtTrainArmyTroopCount[$eTroopFirecracker], $GUI_SHOW)
	GUICtrlSetState($g_ahPicTrainArmyTroop[$eTroopRamRider], $GUI_SHOW)
	GUICtrlSetState($g_ahTxtTrainArmyTroopCount[$eTroopRamRider], $GUI_SHOW)
