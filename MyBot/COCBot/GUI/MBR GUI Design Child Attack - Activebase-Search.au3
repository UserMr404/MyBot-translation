...
Global $g_hChkABActivateTrophies = 0, $g_hTxtABTrophiesMin = 0, $g_hTxtABTrophiesMax = 0  ; Trophy limit
...
Global $g_hChkABWaitForCastle = 0

Global $g_hLblABSearches = 0, $g_hLblABTrophies = 0, $g_hLblABArmyCamps = 0
...
Func CreateAttackSearchActiveBaseSearch()
	...
	$y += 21
	$g_hChkABActivateTrophies = GUICtrlCreateCheckbox(GetTranslatedFileIni("MBR GUI Design Child Attack - Search", "ChkActivateTropies", -1), $x, $y, 68, 18)
	...
	$g_hTxtABTrophiesMin = GUICtrlCreateInput("0", $x + 70, $y, 40, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
	...
	_GUICtrlSetTip(-1, GetTranslatedFileIni("MBR GUI Design Child Attack - Search", "LblActivateMinTropies_Info_01", -1) & @CRLF & @CRLF & _
			GetTranslatedFileIni("MBR GUI Design Child Attack - Search", "ChkActivateTropies_Info_02", -1))
	GUICtrlSetLimit(-1, 6)
	$g_hLblABTrophies = GUICtrlCreateLabel("-", $x + 113, $y + 2, -1, -1)
	GUICtrlSetState(-1, $GUI_DISABLE)
	$g_hTxtABTrophiesMax = GUICtrlCreateInput("6000", $x + 120, $y, 40, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
	GUICtrlSetState(-1, $GUI_DISABLE)
	...
	$y += 21
	$g_hChkABNotWaitHeroes = GUICtrlCreateCheckbox(GetTranslatedFileIni("MBR GUI Design Child Attack - Search", "ChkNotWaitHeroes", -1), $x, $y, -1, 18)
	...
	Local $x = 220, $y = 45
	$g_hGrpABFilter = GUICtrlCreateGroup(GetTranslatedFileIni("MBR GUI Design Child Attack - Search", "Group_02", -1), $x - 20, $y - 20, 225, 310)
	$x -= 15
