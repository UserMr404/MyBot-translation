...
Func LoadTranslatedDropOrderList()
	Global $g_asDropOrderList = [ _
			...
			"Wall Breakers", "Super Wall Breakers", "Balloons", "Rocket Balloons", "Wizards", "Super Wizards", "Healers", _
 			"Dragons", "Super Dragon", "Pekkas", "Baby Dragons", "Inferno Dragons", "Miners", "Super Miners", "Electro Dragons", "Yetis", "Super Yetis", "Dragon Riders", _
 			"Electro Titans", "Root Riders", "Throwers", "Meteor Golems", "Minions", "Super Minions", "Hog Riders", "Super Hog Riders", "Valkyries", "Super Valkyries", "Golems", _
			"Witches", "Super Witches", "Lava Hounds", "Ice Hounds", "Bowlers", "Super Bowlers", "Ice Golems", "Headhunters", "Apprentice Wardens", "Druids", "Furnaces", _
			"Clan Castle", "Heroes", "Ice Minions", "Ice Wizards", "Giant Giants", "Azure Dragons", "Firecrackers", "Ram Riders"]
