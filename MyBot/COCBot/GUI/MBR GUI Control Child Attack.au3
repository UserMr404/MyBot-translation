...
Func radHerosApply()
	...
	GUICtrlSetState($g_hRadAutoDragonDukeAbility, $g_iActivateDragonDuke = 0 ? $GUI_CHECKED : $GUI_UNCHECKED)
	GUICtrlSetState($g_hRadManDragonDukeAbility, $g_iActivateDragonDuke = 1 ? $GUI_CHECKED : $GUI_UNCHECKED)
	GUICtrlSetState($g_hRadBothDragonDukeAbility, $g_iActivateDragonDuke = 2 ? $GUI_CHECKED : $GUI_UNCHECKED)
	GUICtrlSetData($g_hTxtManDragonDukeAbility, ($g_iDelayActivateDragonDuke / 1000))
