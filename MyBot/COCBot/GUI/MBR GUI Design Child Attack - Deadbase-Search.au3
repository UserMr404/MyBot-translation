...
Global $g_hChkDBActivateTrophies = 0, $g_hTxtDBTrophiesMin = 0, $g_hTxtDBTrophiesMax = 0  ; Trophy limit
...
Global $g_hChkDBWaitForCastle = 0

Global $g_hLblDBSearches = 0, $g_hLblDBTrophies = 0, $g_hLblDBArmyCamps = 0
...
Func CreateAttackSearchDeadBaseSearch()
	...
	Local $sTxtTip = ""
	Local $x = 25, $y = 45
	GUICtrlCreateGroup(GetTranslatedFileIni("MBR GUI Design Child Attack - Search", "Group_01", "Search Conditions"), $x - 20, $y - 20, 190, 106)
	$x -= 15
	...
	$y += 21
	$g_hChkDBActivateTrophies = GUICtrlCreateCheckbox(GetTranslatedFileIni("MBR GUI Design Child Attack - Search", "ChkActivateTropies", "Trophies"), $x, $y, 68, 18)
	...
	$g_hTxtDBTrophiesMin = GUICtrlCreateInput("0", $x + 70, $y, 40, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
	...
	GUICtrlSetLimit(-1, 6)
	$g_hLblDBTrophies = GUICtrlCreateLabel("-", $x + 113, $y + 2, -1, -1)
	GUICtrlSetState(-1, $GUI_DISABLE)
	$g_hTxtDBTrophiesMax = GUICtrlCreateInput("6000", $x + 120, $y, 40, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
	GUICtrlSetState(-1, $GUI_DISABLE)
	...
	$y += 21
	$g_hChkDBNotWaitHeroes = GUICtrlCreateCheckbox(GetTranslatedFileIni("MBR GUI Design Child Attack - Search", "ChkNotWaitHeroes", "Not Wait For Heroes"), $x, $y, -1, 18)
	...
	Local $x = 220, $y = 45
	$g_hGrpDBFilter = GUICtrlCreateGroup(GetTranslatedFileIni("MBR GUI Design Child Attack - Search", "Group_02", "Filters"), $x - 20, $y - 20, 225, 310)
	$x -= 15
	...
	$y += 23
	GUICtrlCreateGroup(GetTranslatedFileIni("MBR GUI Design Child Attack - Search", "Group_03", "Weak Base | Max Defense Level"), $x, $y, 215, 120)
	$x += 5
	$y += 20
